...
{{--                        value="">--}}
                    <button type="submit" id="form_submit" class="block w-full items-center bg-red-500 text-white border-0 py-2 focus:outline-none hover:bg-red-600 rounded text-base mt-4 md:mt-0">Pay + Continue</button>
                </div>
            </form>
        </div>
    </section>
